...
func (_m *MockBackend) Ensure() (bool, error) {
...
func (_mr *MockBackendMockRecorder) Ensure() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "Ensure")
}
...
func (_mr *MockVaultSysMockRecorder) ListMounts() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ListMounts")
}
...
func (_mr *MockVaultSysMockRecorder) ListPolicies() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ListPolicies")
}
